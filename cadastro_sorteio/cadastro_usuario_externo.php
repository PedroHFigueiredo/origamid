...
<div class="container" style="width: 400px; margin-top: 40px">
 <img src="imagens/logo_cld.png" width="300px">   
...
<form action="_insert_usuario_externo.php" method="post">
  ...
  <div class="form-group">
      ...
      <input type="password" name="senhausuario" id="senhausuario" class="form-control" required autocomplete="off" placeholder="Senha Usuário">
  </div>
  <div class="form-group">
